...
export const WMON_ADDRESS = process.env.WMON_ADDRESS || '';
...
export const WMON_ATOKEN = process.env.WMON_ATOKEN || '';
...
export const WMON_VARIABLEDEBT_TOKEN = process.env.WMON_VARIABLEDEBT_TOKEN || '';
export const DAI_VARIABLEDEBT_TOKEN = process.env.DAI_VARIABLEDEBT_TOKEN || '';
